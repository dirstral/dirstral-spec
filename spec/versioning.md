...
- `language_identifier` is recorded on the transcript `meta_json`. The identifier, its effective probe length, the candidate lists and, under `require_validation`, the resolved eligibility join the transcript derivation identity (§8.6.7).
